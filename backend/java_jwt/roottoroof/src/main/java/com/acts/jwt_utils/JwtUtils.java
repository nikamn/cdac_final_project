...
import com.acts.security.CustomUserDetails;
...
//JWT : userName,issued at ,exp date,digital signature(does not typically contain password , can contain authorities
	...
	public Claims validateJwtToken(String jwtToken) {
		// try {
		Claims claims = Jwts.parserBuilder().setSigningKey(key).build()// Sets the signing key used to verify JWT digital signature.
