    ...
    <section className="flex flex-col md:flex-row">
          ...
          <div className="p-10 mt-5 mx-3 shadow-md rounded-xl flex">
            <div className="flex-1">
              ...
              <p className="text-base font-medium text-justify py-4">
                In feng shui, plants always represent health, healing,
                refreshing energy, and growth. They represent the earth element
                and the wood element, bringing balance and cleansing energy to
                every space. They are also one of the easiest ways to add life
                to your space!
              </p>
            </div>
            <div className="flex-1">
              <div className="p-3">
                ...
                <img
                  ...
                  style={{ marginLeft: "65px", width: "55%" }}
                />
              </div>
            </div>
          </div>
        ...
        <Link to="/blog/post/2">
          <div className="p-10 mt-5 mx-3 shadow-md rounded-xl flex">
            <div className="flex-1">
              ...
              <p className="text-base font-medium text-justify py-4">
                Bone meal is a great fertilizer for plants because it is high in
                nitrogen, phosphorus, and potassium. It can help improve plants'
                growth in many ways, including providing them with the nutrients
                they need to thrive.
              </p>
            </div>
            <div className="flex-1">
        ...
        <Link to="/blog/post/3">
          <div className="p-10 mt-5 mx-3 shadow-md rounded-xl flex ">
            <div className="flex-1">
              ...
              <p className="text-base font-medium text-justify py-4">
                While not a dwarf variety, Bluecrop is a good choice for
                container gardening because it has a shallow root system and
                produces large, juicy berries. It is also self-fertile and
            ...
            <div className="flex-1">
              <div className="p-3">
                ...
                <img
                  ...
                  alt="Bone Meal"
                  className="w-full rounded-md"
                  style={{ marginTop: "0px", marginLeft: "65px", width: "55%" }}
                />
              </div>{" "}
            </div>
          </div>
      ...
      <div className="w-full md:w-1/2 p-5 bg-[#023F3A]">
        ...
        <p className="text-white text-base font-medium text-justify py-6">
          ...
          Organics is here to guide you on your organic journey. Let's cultivate
          a healthier, more sustainable future together, from the root to the
          roof.
        </p>
